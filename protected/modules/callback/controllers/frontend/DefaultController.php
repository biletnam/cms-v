...
class DefaultController extends FrontEndController
{
    ...
    {
        $this->metaInfoGenerate('Контактная информация', '', '');
        $this->breadcrumbs[] = 'Контактная информация';
        ...
        if (isset($_POST['CallbackForm']))
        {
            ...
            if ($model->validate())
            {
                if(CallbackConfig::model()->checkTimeout())
                {
                    ...
                    Yii::app()->user->setFlash('callback_message', 'Разрешено отправлять одно сообщение в ' . $config->timeout . ' минут.');
            }
